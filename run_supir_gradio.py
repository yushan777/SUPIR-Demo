    ...
    with gr.Blocks(title="SUPIR Detailer/Enhancer/Upscaler", theme=custom_theme,  
        ...
        with gr.Tabs() as tabs:
            ...
            with gr.TabItem("2. SUPIR", id=1):
                ...
                | `CFG Sweep Direction` | Determines the direction of the sweep. `Forward` goes from `CFG Scale Start` to `CFG Scale End`. `Backward` goes from `CFG Scale End` to `CFG Scale Start`. |
